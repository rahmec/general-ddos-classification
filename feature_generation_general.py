...
threads = []
for df in dfs:
    threads.append(threading.Thread(target=add_flow_number_column, args=(df,)))
...
for seq_length in packet_seq_lengths:
    threads.append(threading.Thread(target=aggregate_df, args=(seq_length,"packets")))
print(f"Generated threads for packet sequences with length {packet_seq_lengths}")
for seq_length in time_seq_lengths:
    threads.append(threading.Thread(target=aggregate_df, args=(seq_length,"time")))
print(f"Generated threads for time sequences with length {time_seq_lengths}")
